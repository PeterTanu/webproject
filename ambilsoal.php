...
<div class="info" style="display:<?php echo $display ?>"><?php echo $pemberitahuan; ?></div>
	...
	<form id="frmAmbil" action="soal.php" method="POST">
	<center>
	Nama 	:<input type="text" name="nama" placeholder="Masukkan Nama Anda" required>

	<br><br>Level : <select name="level">
				<option value="1 - Beginner" selected>1 - Beginner</option>
	...
	<ul>
		...
		<li>Soal memiliki tingkat kesulitan masing-masing yang bisa di pilih di pilihan level di atas</li>
		...
		<li>Skor akan di tampilkan di score board yang ada di <a href="index.php" target="_blank">homepage</a></li>
		<li>Tiap jawaban salah akan ada pembahasan tentang jawaban tersebut di tombol (?) di sebelah soal</li>
	</ul>
